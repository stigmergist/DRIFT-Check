...
## What You Work With: The Core Decision Patterns
...
- [proceed.md](proceed.md): You've checked context; conditions are clear. When it's right to move forward.
- [align_context.md](align_context.md): You have a plan, but shared understanding is cracking. When teams interpret the same decision differently.
- [probe.md](probe.md): You don't know if X causes Y. When uncertainty is high enough to test before committing.
- [stop.md](stop.md): When is it time to end an initiative? Not the same as failure; sometimes stopping is winning.

## How You Intervene: Building Capability

When an intervention target is clear, one of these three applies:

- [stabilise.md](stabilise.md): Restore predictability and control. Get outcomes consistent before trying to make them better.
- [rationalise.md](rationalise.md): Remove what's not needed. Reduce the surface area so you can understand what remains.
- [optimise.md](optimise.md): Make it better. Only works if outcomes are already reliable; otherwise you're amplifying chaos.

## What Actually Happens: Signals, Fragility, and the Limits of Control

These concepts explain why systems behave as they do, and why interventions often fail to have the effect you expected:
...
- [fragility.md](fragility.md): When small issues cascade into system failure. Usually invisible until it happens.
- [visibility_control_tension.md](visibility_control_tension.md): What is easiest to measure is often what you can least afford to change.
- [reversibility.md](reversibility.md): Can you undo a wrong decision? Shapes whether you should wait for more certainty.
...
Once you know what you're trying to do, these concepts explain how to know if it's working:

- [value.md](value.md): Value is not generated; it is realized when outputs are actually used for impact. Important distinction.
- [progress.md](progress.md): How to tell if you're improving at reliable, efficient outcome production. Not the same as velocity or features delivered.
...
- [README.md](README.md): Wiki architecture and operating loop.
- [_concepts_vocabulary.md](_concepts_vocabulary.md): Canonical concept list for exploring the landscape.
- [sources.md](sources.md): Source ingest coverage and traceability.
- [log.md](log.md): Append-only operation timeline.
